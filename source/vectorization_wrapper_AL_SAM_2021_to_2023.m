...
% % OutputDirectory = 'E:\Linninger\' ; % on UT computer
% OutputDirectory = 'D:\SAM\Subj58\' ; % on UI computer
% input_names{ 1 } = 'Z2967_to_Z3104.tif' ; % 
...
% OutputDirectory  = 'D:\SAM\osf\Subject_03\biasCor\TOF_3D_160um_TR20_TE6p56_sli52_FA18_FCY_BW100_29_biasCor.nii\';
% % input_names{ 1 } = 'TOF_3D_160um_TR20_TE6p56_sli52_FA18_FCY_BW100_29_biasCor.nii'; % !!! make this filetype an accepted input !!!!
% input_names{ 1 } = 'TOF_3D_160um_TR20_TE6p56_sli52_FA18_FCY_BW100_29_biasCor.tif';
% microns_per_voxel( 1, 1 : 3 ) = [0.159, 0.159, 0.160]; % [ y, x, z ] == !!!!milimeters!!!!!!!_per_voxel - SAM 6/16/21

OutputDirectory  = 'D:\SAM\osf\Subject_03\raw\';
input_names{ 1 } = stitch_tifs(OutputDirectory); % !!! stitch niftis instead !!!
% input_names{ 1 } = 'TOF_3D_160um_TR20_TE6p56_sli52_FA18_FCY_BW100_stitched.tif';
microns_per_voxel( 1, 1 : 3 ) = [0.159, 0.159, 0.160]; % [ y, x, z ] == !!!!milimeters!!!!!!!_per_voxel - SAM 6/16/21

% % OutputDirectory  = 'D:\SAM\OHSU\' % !!!! requires skull stripping !!!!
    ...
    switch start_workflow
        case 'energy'
            name_value_pair_inputs = { 'OutputDirectory', OutputDirectory, ...
                        ...
                        'radius_of_smallest_vessel_in_microns', microns_per_voxel( stackID, 1 ), ... %  'Subj58\Z2967_to_Z3104.tif'
                        'radius_of_largest_vessel_in_microns', microns_per_voxel( stackID, 1 )*7, ... %  'Subj58\Z2967_to_Z3104.tif'
                        'radius_of_smallest_vessel_in_microns', microns_per_voxel( stackID, 1 )*1.5, ... % 'TOF_3D_160um_TR20_TE6p56_sli52_FA18_FCY_BW100_29_biasCor.tif'
                        'radius_of_largest_vessel_in_microns', microns_per_voxel( stackID, 1 )*21, ... % 'TOF_3D_160um_TR20_TE6p56_sli52_FA18_FCY_BW100_29_biasCor.tif'
